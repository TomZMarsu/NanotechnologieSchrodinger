...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.elementCountWidget = QWidget(self.environmentTab)
        self.elementCountWidget.setObjectName(u"elementCountWidget")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Maximum)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.elementCountWidget.sizePolicy().hasHeightForWidth())
        self.elementCountWidget.setSizePolicy(sizePolicy2)
        self.gridLayout = QGridLayout(self.elementCountWidget)
        self.gridLayout.setObjectName(u"gridLayout")
        self.elementCountMaximumLabel = QLabel(self.elementCountWidget)
        self.elementCountMaximumLabel.setObjectName(u"elementCountMaximumLabel")
        self.elementCountMaximumLabel.setText(u"2000")

        self.gridLayout.addWidget(self.elementCountMaximumLabel, 1, 3, 1, 1)

        self.elementCountLabel = QLabel(self.elementCountWidget)
        self.elementCountLabel.setObjectName(u"elementCountLabel")

        self.gridLayout.addWidget(self.elementCountLabel, 1, 0, 1, 1)

        self.elementCountSlider = QSlider(self.elementCountWidget)
        self.elementCountSlider.setObjectName(u"elementCountSlider")
        self.elementCountSlider.setMinimum(10)
        self.elementCountSlider.setMaximum(2000)
        self.elementCountSlider.setValue(500)
        self.elementCountSlider.setOrientation(Qt.Orientation.Horizontal)
        self.elementCountSlider.setTickPosition(QSlider.TickPosition.TicksAbove)

        self.gridLayout.addWidget(self.elementCountSlider, 1, 2, 1, 1)

        self.elementCountMinimumLabel = QLabel(self.elementCountWidget)
        self.elementCountMinimumLabel.setObjectName(u"elementCountMinimumLabel")
        self.elementCountMinimumLabel.setText(u"10")

        self.gridLayout.addWidget(self.elementCountMinimumLabel, 1, 1, 1, 1)

        self.elementCountCurrentLabel = QLabel(self.elementCountWidget)
        self.elementCountCurrentLabel.setObjectName(u"elementCountCurrentLabel")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.elementCountCurrentLabel.sizePolicy().hasHeightForWidth())
        self.elementCountCurrentLabel.setSizePolicy(sizePolicy3)
        self.elementCountCurrentLabel.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.elementCountCurrentLabel.setText(u"500")
        self.elementCountCurrentLabel.setAlignment(Qt.AlignmentFlag.AlignBottom|Qt.AlignmentFlag.AlignHCenter)

        self.gridLayout.addWidget(self.elementCountCurrentLabel, 0, 2, 1, 1)


        self.verticalLayout_4.addWidget(self.elementCountWidget)
        ...
        self.particleMassWidget = QWidget(self.environmentTab)
        self.particleMassWidget.setObjectName(u"particleMassWidget")
        sizePolicy.setHeightForWidth(self.particleMassWidget.sizePolicy().hasHeightForWidth())
        self.particleMassWidget.setSizePolicy(sizePolicy)
        self.horizontalLayout_6 = QHBoxLayout(self.particleMassWidget)
        self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
        self.particelMassLabel = QLabel(self.particleMassWidget)
        self.particelMassLabel.setObjectName(u"particelMassLabel")
        sizePolicy.setHeightForWidth(self.particelMassLabel.sizePolicy().hasHeightForWidth())
        self.particelMassLabel.setSizePolicy(sizePolicy)

        self.horizontalLayout_6.addWidget(self.particelMassLabel)

        self.particleMassComboBox = QComboBox(self.particleMassWidget)
        self.particleMassComboBox.addItem("")
        self.particleMassComboBox.addItem("")
        self.particleMassComboBox.addItem("")
        self.particleMassComboBox.setObjectName(u"particleMassComboBox")
        self.particleMassComboBox.setEnabled(True)
        self.particleMassComboBox.setMinimumSize(QSize(200, 0))
        self.particleMassComboBox.setMaximumSize(QSize(200, 16777215))

        self.horizontalLayout_6.addWidget(self.particleMassComboBox)

        self.customParticleMassLabel = QLabel(self.particleMassWidget)
        self.customParticleMassLabel.setObjectName(u"customParticleMassLabel")
        sizePolicy.setHeightForWidth(self.customParticleMassLabel.sizePolicy().hasHeightForWidth())
        self.customParticleMassLabel.setSizePolicy(sizePolicy)

        self.horizontalLayout_6.addWidget(self.customParticleMassLabel)

        self.customParticleMassLineEdit = QLineEdit(self.particleMassWidget)
        self.customParticleMassLineEdit.setObjectName(u"customParticleMassLineEdit")
        self.customParticleMassLineEdit.setEnabled(False)
        self.customParticleMassLineEdit.setMaximumSize(QSize(200, 16777215))
        self.customParticleMassLineEdit.setText(u"")
        self.customParticleMassLineEdit.setMaxLength(30)

        self.horizontalLayout_6.addWidget(self.customParticleMassLineEdit)


        self.verticalLayout_4.addWidget(self.particleMassWidget)
    ...
    def retranslateUi(self, Form):
        ...
        self.elementCountLabel.setText(QCoreApplication.translate("Form", u"Po\u010det simula\u010dn\u00edch prvk\u016f (v\u00edc prvk\u016f = vy\u0161\u0161\u00ed p\u0159esnost, vy\u0161\u0161\u00ed n\u00e1roky na v\u00fdpo\u010det a pam\u011b\u0165)", None))
        ...
        self.particelMassLabel.setText(QCoreApplication.translate("Form", u"Hmotnost \u010d\u00e1stice (kg)", None))
        self.particleMassComboBox.setItemText(0, QCoreApplication.translate("Form", u"Elektron (9.109e-31)", None))
        self.particleMassComboBox.setItemText(1, QCoreApplication.translate("Form", u"Proton (1.673e-27)", None))
        self.particleMassComboBox.setItemText(2, QCoreApplication.translate("Form", u"Vlastn\u00ed \u010d\u00e1stice", None))

        self.customParticleMassLabel.setText(QCoreApplication.translate("Form", u"nebo vlastn\u00ed hmotnost \u010d\u00e1stice (kg)", None))
        self.customParticleMassLineEdit.setPlaceholderText(QCoreApplication.translate("Form", u"1.234e-56", None))
